<template>
  <div class="detail top-page" ref="detailRef">
    <TabControl class="tabs" :titles="names" v-if="isShowControl" @tab-click="tabClick" ref="tabControl"></TabControl>
    ...
    <div class="main" v-if="mainPart" v-memo="[mainPart]">
      ...
      <DetailLandlord :ref="getSectionRef" ref="landlordRef" name="房东"
        :landlord-module="mainPart.dynamicModule.landlordModule">
      </DetailLandlord>
      <DetailComment :ref="getSectionRef" name="评论" :comment-module="mainPart.dynamicModule.commentModule">
      </DetailComment>
      <DetailNotice :ref="getSectionRef" name="须知" :orderRules="mainPart.dynamicModule.rulesModule.orderRules">
      </DetailNotice>
      <DetailMap :ref="getSectionRef" name="周边" :position-module="mainPart.dynamicModule.positionModule"></DetailMap>
